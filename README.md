...
Similarly, for ATI dataset we release a new single run, that combines all the scenes observes by the existing 6 testing runs, is more longer and has more loops compared to the previous testing runs. The same is updated in the Kaggle dataset link updated in the dataset folder. The breakdown of this into training, validation and testing sets for models is also available at the Kaggle link - [ARD-16](https://www.kaggle.com/datasets/ssahoodotinfinity/ard16-dynamic-static-lidar-dataset)
